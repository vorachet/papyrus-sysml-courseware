...
import HSUVModel.HSUVRequirements.HSUVRequirementsFactory;
import HSUVModel.HSUVRequirements.HSUVRequirementsPackage;
import HSUVModel.HSUVRequirements.Performance;
 ...
 * @generated
 */
public class HSUVRequirementsPackageImpl extends EPackageImpl implements HSUVRequirementsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see HSUVModel.HSUVRequirements.HSUVRequirementsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private HSUVRequirementsPackageImpl() {
		super(eNS_URI, HSUVRequirementsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link HSUVRequirementsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static HSUVRequirementsPackage init() {
		if (isInited) return (HSUVRequirementsPackage)EPackage.Registry.INSTANCE.getEPackage(HSUVRequirementsPackage.eNS_URI);

		// Obtain or create and register package
		HSUVRequirementsPackageImpl theHSUVRequirementsPackage = (HSUVRequirementsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HSUVRequirementsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new HSUVRequirementsPackageImpl());
		...
		theHSUVRequirementsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(HSUVRequirementsPackage.eNS_URI, theHSUVRequirementsPackage);
		return theHSUVRequirementsPackage;
	}
	 ...
	 * @generated
	 */
	public HSUVRequirementsFactory getHSUVRequirementsFactory() {
		return (HSUVRequirementsFactory)getEFactoryInstance();
	}
